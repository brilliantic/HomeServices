    ...
    (() => {
        ...
        const addBlogCart = function() {
            ...
            function initBlog(data) {
                ...
                setTimeout((() => {
                    showMoreButton.style.display = itemsToShow < data.items.length ? "block" : "none";
                }), 3e3);
